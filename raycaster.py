...
wall1 = pygame.image.load('./sprites/minecraftBlock.jpg')
wall2 = pygame.image.load('./sprites/pokecenter.png')
wall3 = pygame.image.load('./sprites/BlockMine.png')


dragon = pygame.image.load('./sprites/Chori.png')
background = pygame.image.load('./sprites/grass.png')

hand = pygame.image.load('./sprites/Pokeball.png')
trophy = pygame.image.load('./sprites/Medalla.png')
...
class Raycaster:
    ...
    def game_intro(self):
        ...
        while intro:
            ...
            TextSurf, TextRect = self.text_objects(
                "PokeAventura", largeText)
            TextRect.center = (int(600/2), int(400/2))
            gameDisplay.blit(TextSurf, TextRect)
            TextSurf, TextRect = self.text_objects(
                "Presiona espacio", mediumText)
    ...
    def game_over(self):
        ...
        while intro:
            ...
            smallText = pygame.font.Font('freesansbold.ttf', 20)
            TextSurf, TextRect = self.text_objects(
                "Oh no, perdiste", largeText)
            TextRect.center = (int(600/2), int(400/2))
            gameDisplay.blit(TextSurf, TextRect)
            TextSurf, TextRect = self.text_objects(
                "Presiona espacio para volverlo a intentar", mediumText)
            TextRect.center = (int(600/2), int(600/2))
            gameDisplay.blit(TextSurf, TextRect)
            TextSurf, TextRect = self.text_objects(
                "", smallText)
    ...
    def game_win(self):
        ...
        while intro:
            ...
            gameDisplay.blit(TextSurf, TextRect)
            TextSurf, TextRect = self.text_objects(
                "Presiona espacio para seguir ", mediumText)
            TextRect.center = (int(600/2), int(600/2))
            gameDisplay.blit(TextSurf, TextRect)
            TextSurf, TextRect = self.text_objects(
                "", smallText)
    ...
    def game_start(self):
        pygame.mixer.music.load('OaksLaboratory.mp3')
        pygame.mixer.music.set_volume(1)
